import{r as t,b as k,j as e}from"./app-DJgVNCKy.js";import{c as n}from"./createLucideIcon-DP5VJLqL.js";import{X as _}from"./x-zDG3bqyt.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U=[["path",{d:"M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z",key:"4pj2yx"}],["path",{d:"M20 3v4",key:"1olli1"}],["path",{d:"M22 5h-4",key:"1gvqau"}],["path",{d:"M4 17v2",key:"vumght"}],["path",{d:"M5 18H3",key:"zchphs"}]],q=n("sparkles",U);function L(){const[b,p]=t.useState(!1),[o,l]=t.useState([{id:0,text:"Hello! 👋 Welcome to the Barangay AI Assistant. How can I help you today?",isUser:!1}]),[i,m]=t.useState(""),[r,d]=t.useState(!1),[y,j]=t.useState([]),[v,N]=t.useState(""),[f,M]=t.useState(!0),w=t.useRef(null);t.useEffect(()=>{const s=`session_${Date.now()}_${Math.random().toString(36).substr(2,9)}`;N(s),S()},[]),t.useEffect(()=>{var s;(s=w.current)==null||s.scrollIntoView({behavior:"smooth"})},[o,r]);const S=async()=>{try{const s=await k.get("/api/chatbot/prompts");s.data.success&&j(s.data.prompts)}catch(s){console.error("Failed to fetch prompts:",s)}},c=async(s=null)=>{const x=s||i.trim();if(!x)return;f&&M(!1);const I={id:Date.now(),text:x,isUser:!0};l(a=>[...a,I]),m(""),d(!0);try{const a=await k.post("/api/chatbot/send",{message:x,session_id:v});if(d(!1),a.data.success){const h={id:Date.now()+1,text:a.data.response,isUser:!1,messageId:a.data.message_id};l(g=>[...g,h])}}catch(a){d(!1);const h={id:Date.now()+1,text:"Sorry, I'm having trouble connecting right now. Please try again later.",isUser:!1};l(g=>[...g,h]),console.error("Failed to send message:",a)}},z=s=>{c(s)};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"fixed bottom-6 right-6 z-[9999]",children:e.jsx("button",{onClick:()=>p(s=>!s),"aria-label":"Toggle chat",className:`transition-transform hover:scale-105 active:scale-95 
            focus:outline-none`,children:b?e.jsx("div",{className:`w-16 h-16 flex items-center justify-center rounded-full
              bg-blue-700 text-white shadow-xl hover:bg-blue-800`,children:e.jsx(C,{size:28})}):e.jsx("img",{src:"/images/chatbot.png",alt:"Ask for Help - Chat Bot",className:"w-auto h-24 object-contain drop-shadow-2xl animate-bounce [animation-duration:2s]"})})}),b&&e.jsxs("div",{className:`fixed bottom-24 right-6 z-[9998]
            w-[380px] flex flex-col rounded-2xl overflow-hidden
            border border-gray-200 dark:border-gray-700
            bg-white dark:bg-gray-900 shadow-xl`,style:{height:550},children:[e.jsxs("div",{className:"bg-gradient-to-r from-blue-700 to-blue-600 px-4 py-3 flex items-center gap-3",children:[e.jsx("div",{className:`w-9 h-9 rounded-full bg-white/20
              flex items-center justify-center`,children:e.jsx(u,{size:18,className:"text-white"})}),e.jsxs("div",{className:"flex-1",children:[e.jsxs("p",{className:"text-white font-semibold text-sm flex items-center gap-1",children:["Barangay AI Assistant",e.jsx(q,{size:12,className:"text-yellow-300"})]}),e.jsxs("p",{className:"text-blue-200 text-xs flex items-center gap-1",children:[e.jsx("span",{className:`w-2 h-2 rounded-full bg-green-400
                  inline-block animate-pulse`}),"Online & Ready to Help"]})]}),e.jsx("button",{onClick:()=>p(!1),className:"text-white/80 hover:text-white transition-colors","aria-label":"Close",children:e.jsx(_,{size:18})})]}),e.jsxs("div",{className:`flex-1 overflow-y-auto p-4 space-y-3
            bg-gray-50 dark:bg-gray-800`,children:[o.map(s=>e.jsxs("div",{className:`flex items-end gap-2
                  ...
                  flex items-center justify-center flex-shrink-0`,children:e.jsx(u,{size:13,className:"text-white"})}),e.jsx("div",{className:`bg-white dark:bg-gray-700 border
            ...
            dark:border-gray-700 bg-white dark:bg-gray-900`,children:[e.jsxs("div",{className:"flex gap-2 items-center",children:[e.jsx("input",{type:"text",value:i,onChange:s=>m(s.target.value),onKeyDown:s=>s.key==="Enter"&&!s.shiftKey&&c(),placeholder:"Type your question…",disabled:r,className:`flex-1 px-4 py-2.5 rounded-full text-sm
                  border border-gray-200 dark:border-gray-600
                  ...
                  transition-all`}),e.jsx("button",{onClick:()=>c(),disabled:r||!i.trim(),"aria-label":"Send",className:`w-10 h-10 rounded-full bg-blue-700 text-white
