import{P as g,r as x,j as e,W as c}from"./app-CqHqVwvg.js";import{F as m,a as b}from"./index-De-11xjh.js";import"./iconBase-Cv6y-Nly.js";function w(){const{data:a,setData:t,post:s,processing:n,errors:r}=g({email:"",password:"",remember:!1}),[o,l]=x.useState(!1),p=()=>l(i=>!i),d=i=>{i.preventDefault(),s(route("auth.login"))};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
