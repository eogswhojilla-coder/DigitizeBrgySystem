...
@section('content')
    <h1 style="text-align: center; margin: 30px 0;">BARANGAY CLEARANCE</h1>
    ...
    <p style="text-align: justify; line-height: 1.6;">
        ...
        <strong>{{ $residentAddress }}</strong>, is a bonafide resident of this Barangay and has no derogatory record 
