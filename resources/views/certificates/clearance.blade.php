...
<head>
    ...
    <style>
        ...
        .photo-box {
            position: absolute;
            right: 40px;
            /* smaller value = closer to the right edge */
            top: 180px;
            width: 100px;
            height: 100px;
...
<body>
    ...
    <div class="content">
        ...
        <p style="text-indent: 40px;">
            This is to certify that <strong><u>{{ strtoupper($residentName ?? 'ROMANO, JANVEE MARTISANO') }}</u></strong>,
            {{ $residentAge ?? '21' }} years old,
            <strong><u>{{ ucfirst($residentCivilStatus ?? 'Single') }}</u></strong>
            whose specimen signature appears herein below, a bona fide resident of
            <strong><u>{{ strtoupper($residentAddress ?? 'PRES. QUIRINO ST. DON JUAN SUBD., BARANGAY II, SAN CARLOS CITY, NEGROS OCCIDENTAL, NEGROS ISLAND REGION') }}</u></strong>, Philippines.
        </p>

        <p style="text-indent: 40px;">
            This is to certify further that the undersigned can vouch for his/her good moral character, integrity and no derogative record within the jurisdiction of this Barangay.
        </p>
    ...
    <!-- Note -->
    <div class="note">
        <p><strong>Note:</strong> This Clearance is valid for Six(6) months after the date of issue.</p>
    </div>
