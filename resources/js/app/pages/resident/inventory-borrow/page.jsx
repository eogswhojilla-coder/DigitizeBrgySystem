...
export default function Page() {
    ...
    const fetchAvailableInventories = async () => {
        try {
            ...
            console.error(
                "[Inventory] Error fetching available inventories:",
                error,
            );
            ...
            if (error.response?.status === 401) {
                console.error(
                    "[Inventory] Authentication error - user not logged in or session expired",
                );
            } else if (error.response?.status === 403) {
                console.error(
                    "[Inventory] Permission denied - user doesn't have resident role",
                );
            ...
            <div className="space-y-4 sm:space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-600 mt-1">
                        Request to borrow barangay equipment and supplies
                    </p>
                </div>
                                    ...
                                    <div className="flex flex-wrap gap-4 mt-2 text-sm text-blue-700">
                                        <span>
                                            ...
                                            {selectedItem.quantity -
                                                (selectedItem.borrowed || 0) -
                                                (selectedItem.damaged || 0)}
                                        </span>
                                        <span>•</span>
                                        <span>
                                            Category:{" "}
                                ...
                                <div className="border-t border-gray-200 pt-4 space-y-4">
                                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                        ...
                                        <p className="text-sm text-yellow-800 mb-2">
                                            This item requires a borrowing fee
                                            of{" "}
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                <h4 className="text-green-900 font-bold text-lg mb-1">
                                                    ✅ Request Approved - Ready
                                                    to Pick Up!
                                                </h4>
                                                <p className="text-green-800 text-sm">
                                                    Your borrow request has been
                                                    approved. You can now pick
                                                    up the equipment from the
                                                    location below.
                                                </p>
                                            </div>
                                            ...
                                            {receiptModalOpen && (
                                                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                                                    <div
                                                        className="bg-white rounded-lg shadow-xl p-4 w-full max-w-xs sm:max-w-sm md:max-w-md relative mx-2"
                                                        style={{
                                                            maxWidth: "400px",
                                                        }}
                                                    >
                                                        ...
                                                        <div className="flex flex-col items-center">
                                                            ...
                                                            >
                                                                ...
                                                                ></div>
                                                                <div className="row flex justify-between mb-1 text-xs">
