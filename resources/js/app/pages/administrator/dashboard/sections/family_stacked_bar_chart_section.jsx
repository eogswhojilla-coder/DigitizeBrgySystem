...
import { familyDistributionData } from './dummy_data';

export default function FamilyStackedBarChartSection() {
    return (
        <ChartCardSection
        ...
        >
            <ResponsiveContainer width="100%" height={300}>
                <BarChart data={familyDistributionData} layout="horizontal">
