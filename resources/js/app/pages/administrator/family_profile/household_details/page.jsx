...
function HouseholdDetailsForm() {
  return (
    <div className="max-w-9xl mx-auto p-3 sm:p-4 md:p-6 bg-white rounded-lg shadow-lg">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4 sm:mb-6 pb-4 border-b border-gray-200">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Household Details</h1>
