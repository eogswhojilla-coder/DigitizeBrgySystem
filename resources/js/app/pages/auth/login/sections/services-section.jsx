                    ...
                    {services.map((s, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div
                                    className={`absolute inset-0 rounded-2xl bg-gradient-to-r from-transparent via-${s.iconBg.replace("bg-", "")}/10 to-transparent blur-xl`}
                                />
                            </div>
                            ...
                            <div className="relative z-10">
                                ...
                                {/* Action Button */}
                                <button className="group/btn flex items-center gap-2 text-sm font-medium text-slate-400 hover:text-yellow-400 transition-colors"></button>
                            </div>
