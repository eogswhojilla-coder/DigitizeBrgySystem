            ...
            <div className="max-w-7xl mx-auto px-6 md:px-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {developers.map((dev) => (
                        <div
                            key={dev.id}
                            className="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-white/0 hover:from-yellow-500/50 transition-all duration-500"
                        >
                            {/* Card Content */}
                            <div className="relative h-full bg-slate-900/90 backdrop-blur-xl rounded-xl p-8 flex flex-col items-center text-center border border-white/5 transition-colors duration-300 hover:bg-slate-900/100">
                                ...
                                <div className="relative mb-6 mt-2">
                                    <div className="w-32 h-32 rounded-full p-1 bg-slate-800 ring-4 ring-slate-900 group-hover:ring-yellow-500/50 transition-all duration-500 overflow-hidden relative z-10">
                                        {!imgErrors[dev.id] ? (
                                            <img
                                                src={dev.image}
                                                alt={`${dev.name}`}
                                    ...
                                    <div className="absolute bottom-2 right-2 w-5 h-5 bg-green-500 rounded-full border-4 border-slate-900 z-20" />
                                </div>
